...
public class ItemAssistant {
	...
	**/
	public boolean is2handed(String itemName, int itemId) {
		...
		if (itemName.contains("godsword") || itemName.contains("claws") || itemName.contains("aradomin sword") || itemName.contains("2h") || itemName.contains("maul") || itemName.contains("spear")){ 
			return true;
		}
		switch(itemId) {
			case 6724: 
		...
		synchronized(c) {
			...
			if(c.playerItems[slot] == (wearID+1)) {				
				...
				switch (wearID) {
					...
					case 1189: // primal kite
						targetSlot = 5;
					break;

					case 1117: // primal plate
						targetSlot = 4;
					break;

					case 1155: // primal helm
						targetSlot = 0;
					break;

					case 1075: // primal legs
					case 1087: // primal skirt
						targetSlot = 7;
					break;
	
					case 13035: // primal gloves
						targetSlot = 9;
					break;

					case 13036: // primal boots
						targetSlot = 10;
					break;
					...
					case 15040://Chaotic Staff
						targetSlot = 3;
					break;
					case 6129: // rock-shell platebody
						targetSlot = 4;
					break;
					case 6130: // rock shell platelegs
						targetSlot = 7;
					break;
					...
					case 10378://guthix d'hide
						targetSlot = 4;
					break;
					case 10380://guthix D'hide chaps
						targetSlot = 7;
					break;
					case 10372://Zamorak D'hide
						targetSlot = 7;
					break;
